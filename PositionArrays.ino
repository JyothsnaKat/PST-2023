...
String sensorPositions[] = {"d21", "d2", "d22", "d1", "d0", "d13", "d12", "d10", "d8", "d7", "d4"};
  // String sensorID[] = {"d21", "d2", "d22",  "d0",  "d12", "d10", "d8", "d7", "d4"};
...
DCC_send_command(DCCtrain3,step9,1);
...
void checkTrainPos(String pos) {
  ...
  // if ((train3 == "d22" && pos == "d0") || (train3 == "d0" && pos == "d12")){
  //   train3 = pos;
  //   Serial.print("TRAIN 3 is at "+ pos+"\n");
  // }
