...
void loop() {
//   int stateButton = digitalRead(emergencystop); 
//   if (stateButton == 1)
//   {
//     DCC_send_command(DCCtrain1,emergency,300);
//     DCC_send_command(DCCtrain3,0x00,300);
//   }
// else
// {
// Serial.println("Emergency switch off");

int stateButton = digitalRead(PinButton); 
if (stateButton == 1) 
{
  // stop the trains
       DCC_send_command(DCCtrain1,emergency,1);
...
// DCC_send_command(DCCaddressswitch,sw1inst,1); //loop
// Serial.println("Working Switch 1");
// delay(3000);
// DCC_send_command(DCCaddressswitch,sw1inst,1);
// DCC_send_command(DCCaddressswitch,idleinst,1); //straight
// Serial.println("Working Switch flip");
// delay(3000);
...
//station logic for train1 begin
if(train1 =="d2" && stationtrain1_1 == 0)
{
...
if(train1 == "d12" && stationtrain1_2 == 0)
{

  Serial.println("Train 1 is at station 2");
  digitalWrite(buzzer, LOW); 
  DCC_send_command(DCCtrain1,emergency,300);
  stationtrain1_2 = 1;
}
...
// //station logic for train 1 end

// //station logic begin
if(train3 =="d2" && stationtrain3_1 == 0)
{
  Serial.println("Train 3 is at station 1");
  digitalWrite(buzzer, LOW);
  DCC_send_command(DCCtrain3,0x00,300);
  stationtrain3_1 = 1;
}
...
// if(train3 == "d12" && stationtrain3_2 == 0)
// {
//   Serial.println("Train 3 is at station 2");
//   digitalWrite(buzzer, LOW);
//   DCC_send_command(DCCtrain3,0x00,400);
//   stationtrain3_2 = 1;
// }
if(train3 == "d13")
{
...
// station logic for train 3 ends
...
if(train3=="d22" || train3 =="d1" || train1 == "d10" || train1 == "d8")
{

  Serial.println("I am red now");
  //Serial.println(signal8);
  if(train3=="d1" && signal8 == 0)
  {
    while (val<300)
    {
        setSignalLight8();
  ...
  else if(train3=="d1" && signal8 == 1)
  {
    setSignalLightsGreen();
  }
  else if(train3=="d22" && signal8 == 0)
  {
    Serial.println("I am at d22 red");
    setSignalLight8();
  }
    else
    {
  ...
  mcp.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11111111);//green
}
else
{
  signal3 = 0;
...
void setSignalLightsRed(){
    mcpsignal.writeRegister(MCP23017Register::OLAT_A, (unsigned char )0b11111101);// red
    mcpsignal.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11111111);
        mcpsignal.writeRegister(MCP23017Register::OLAT_A, (unsigned char )0b11110111);//red
    mcpsignal.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11111111);

    mcpsignal.writeRegister(MCP23017Register::OLAT_A, (unsigned char )0b11011111);//red
    mcpsignal.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11111111);
        mcpsignal.writeRegister(MCP23017Register::OLAT_A, (unsigned char )0b01111111);//red
    mcpsignal.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11111111);

    mcpsignal.writeRegister(MCP23017Register::OLAT_A, (unsigned char )0b11111111);
    mcpsignal.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11111101);//red

    mcpsignal.writeRegister(MCP23017Register::OLAT_A, (unsigned char )0b11111111);
    mcpsignal.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11110111);//red

    mcpsignal.writeRegister(MCP23017Register::OLAT_A, (unsigned char )0b11111111);//red
    mcpsignal.writeRegister(MCP23017Register::OLAT_B, (unsigned char )0b11011111);
...
void setSignalLightsGreen() {
 // DCC_send_command(DCCtrain1,step13,1);
