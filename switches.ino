...
// DCC_send_command(DCCaddressswitch,sw2inst,1); //loop
// Serial.println("Working swicth 2");
// delay(3000);
...
// Serial.println("Working swicth 3"); //straight
// delay(3000);
// DCC_send_command(DCCaddressswitch,sw3inst,1);
// DCC_send_command(DCCaddressswitch,idleinst,1); //loop
// Serial.println("Working Switch flip");  
// delay(3000);

DCC_send_command(DCCaddressswitch,sw4inst,1);//straight
Serial.println("Working swicth 4");
